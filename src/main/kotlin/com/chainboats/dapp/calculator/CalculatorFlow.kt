package com.chainboats.dapp.calculator
...
// otherMember in X500 Format
class MyFirstFlowStartArgs(val otherMember: String)
...
@CordaSerializable
class Message(val sender: String, val message: String)
...
class MyFirstFlow: RPCStartableFlow {
    ...
    override fun call(requestBody: RPCRequestData): String {
        ...
        val message = Message(otherMember, "Hello from Error Me.")
        ...
        val session = flowMessaging.initiateFlow(MemberX500Name.parse(otherMember))
...
class MyFirstFlowResponder: ResponderFlow {
    ...
    override fun call(session: FlowSession) {
        ...
        val response = Message("Error.should be my name",
            "Hello ${session.counterparty.commonName}, best wishes from Error get my name")
